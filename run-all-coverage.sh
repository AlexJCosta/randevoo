...
## compile all tests
CP=${PROJECT_CLASSPATH}:${SOURCE}:${JUNIT_JARS}:${EVOSUITE_JAR}:"/home/alex/Documents/GitHub/randevoo/output-tests/1/evosuite-1_tullibee-1559933811-sub/"
...
then
    ...
    ## running tests
    LIST_OF_TESTS="${DIR}/list-of-tests.txt"          
    find . -name "*.class" | sed 's/\.class//g' | sed 's/\.\///g' | sed 's/\//./g' > ${LIST_OF_TESTS}
    ## process file
